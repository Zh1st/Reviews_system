...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 内容头部 /-->
        <form action="${pageContext.request.contextPath}/film/save" method="post" enctype="multipart/form-data">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div style="height: 200px" class="col-md-10 data">
                            ...
                            <img name="uploadImg" id="uploadImg" style="width: 20rem;height: 15rem;" alt="图片预览"/>
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
